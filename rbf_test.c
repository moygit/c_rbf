...
bool test_get_feature_frequencies() {
    ...
    colnum_t feature_num = 0;
    rownum_t index_start = 0, index_end = 10, num_rows = 10;
    // when:
...
bool _test_qp(rownum_t *row_index, size_t ri_size, feature_t *feature_array, feature_t split_value,
    ...
    colnum_t feature_num = 0;
    rownum_t index_start = 0, num_rows = index_end;
    rownum_t split = quick_partition(row_index, feature_array, num_rows, index_start, index_end, feature_num, split_value);
